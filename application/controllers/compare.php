 ...
 * @version   SVN: $Id: compare.php 49626 2012-09-19 05:54:02Z alfonsas $
 */
...
class Compare extends oxUBase
{
    ...
    public function getBreadCrumb()
    {
        ...
        $aPath['title'] = oxRegistry::getLang()->translateString( 'PAGE_PRODUCT_COMPARE_TITLE', oxRegistry::getLang()->getBaseLanguage(), false );
