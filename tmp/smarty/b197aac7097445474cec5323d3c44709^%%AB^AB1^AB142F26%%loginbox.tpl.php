...
">
            ...
            <div class="loginForm corners">
                ...
                <p>
                    ...
                    <input id="loginPasword" type="password" name="lgn_pwd" class="textbox passwordbox" value=""><strong><a class="forgotPasswordOpener" href="#" title="<?php echo smarty_function_oxmultilang(array('ident' => 'WIDGET_LOGINBOX_FORGOT_PASSWORD'), $this);?>
">?</a></strong>
                </p>
