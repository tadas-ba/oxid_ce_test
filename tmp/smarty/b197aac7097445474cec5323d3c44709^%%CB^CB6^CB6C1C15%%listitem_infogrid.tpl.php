...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxhasrights', 'widget/product/listitem_infogrid.tpl', 22, false),array('function', 'oxmultilang', 'widget/product/listitem_infogrid.tpl', 48, false),array('function', 'oxid_include_dynamic', 'widget/product/listitem_infogrid.tpl', 86, false),)), $this); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <?php if ($this->_tpl_vars['product']->getFPrice()): ?>
                                    ...
                                    <?php if ($this->_tpl_vars['oView']->isVatIncluded()): ?>
                                         <?php if (! ( $this->_tpl_vars['product']->hasMdVariants() || ( $this->_tpl_vars['oViewConf']->showSelectListsInList() && $this->_tpl_vars['product']->getSelections(1) ) || $this->_tpl_vars['product']->getVariants() )): ?>*<?php endif; ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
