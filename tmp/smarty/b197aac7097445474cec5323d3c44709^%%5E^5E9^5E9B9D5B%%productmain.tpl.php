...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'page/details/inc/productmain.tpl', 8, false),array('modifier', 'strip_tags', 'page/details/inc/productmain.tpl', 46, false),array('modifier', 'default', 'page/details/inc/productmain.tpl', 113, false),array('modifier', 'oxmultilangassign', 'page/details/inc/productmain.tpl', 113, false),array('modifier', 'strip', 'page/details/inc/productmain.tpl', 331, false),array('modifier', 'escape', 'page/details/inc/productmain.tpl', 331, false),array('function', 'oxscript', 'page/details/inc/productmain.tpl', 15, false),array('function', 'oxmultilang', 'page/details/inc/productmain.tpl', 45, false),array('function', 'oxid_include_dynamic', 'page/details/inc/productmain.tpl', 78, false),array('function', 'oxgetseourl', 'page/details/inc/productmain.tpl', 81, false),array('function', 'mailto', 'page/details/inc/productmain.tpl', 113, false),array('block', 'oxhasrights', 'page/details/inc/productmain.tpl', 18, false),)), $this); ?>
        ...
        <div class="tobasket">
                ...
                <?php if ($this->_tpl_vars['oView']->isPersParam()): ?>
                    <div class="persparamBox clear">
                        <label for="persistentParam"><?php echo smarty_function_oxmultilang(array('ident' => 'LABEL'), $this);?>
 ...
 ?>
                    ...
                    <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'TOBASKET')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                        <?php if (! $this->_tpl_vars['oDetailsProduct']->isNotBuyable()): ?>
                            ...
                            <button id="toBasket" type="submit" <?php if (! $this->_tpl_vars['blCanBuy']): ?>disabled="disabled"<?php endif; ?> class="submitButton largeButton"><?php echo smarty_function_oxmultilang(array('ident' => 'DETAILS_ADDTOCART'), $this);?>
</button>
                        <?php endif; ?>
                    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
