...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'widget/product/bargainitems.tpl', 1, false),array('function', 'oxmultilang', 'widget/product/bargainitems.tpl', 21, false),array('function', 'oxgetseourl', 'widget/product/bargainitems.tpl', 39, false),array('modifier', 'strip_tags', 'widget/product/bargainitems.tpl', 7, false),array('modifier', 'cat', 'widget/product/bargainitems.tpl', 39, false),array('block', 'oxhasrights', 'widget/product/bargainitems.tpl', 16, false),)), $this); ?>
...
">
                ...
                <?php $this->_tag_stack[] = array('oxhasrights', array('ident' => 'SHOWARTICLEPRICE')); $_block_repeat=true;smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
                    ...
                    <?php if ($this->_tpl_vars['tprice'] && $this->_tpl_vars['tprice']->getPrice() > $this->_tpl_vars['price']->getPrice()): ?>
                    <span class="priceOld">
 ...
 <?php echo $this->_tpl_vars['currency']->sign; ?>
                         ...
                         <?php if ($this->_tpl_vars['oView']->isVatIncluded()): ?>
                             <?php if (! ( $this->_tpl_vars['_product']->hasMdVariants() || ( $this->_tpl_vars['oViewConf']->showSelectListsInList() && $this->_tpl_vars['_product']->getSelections(1) ) || $this->_tpl_vars['_product']->getVariants() )): ?>*<?php endif; ?>
                         <?php endif; ?>
                         </span>
                    <?php endif; ?>
...
/<?php echo $this->_tpl_vars['_product']->getUnitName(); ?>
                    ...
                    <?php endif; ?>
                        ...
                        <?php if (! ( $this->_tpl_vars['_product']->hasMdVariants() || ( $this->_tpl_vars['oViewConf']->showSelectListsInList() && $this->_tpl_vars['_product']->getSelections(1) ) || $this->_tpl_vars['_product']->getVariants() )): ?>
